...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    return res.json({ reply: replyText, profileUsed: { tone, dominantSummary, humorLevel, empathyLevel, analyticalDepth }, kdm: { trace: kdm.trace, dynamicState: kdm.nextDynamicState } });
