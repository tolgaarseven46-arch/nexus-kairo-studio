...
describe("LIVE GREEN proof: first-encounter latency v7", () => {
  it("keeps iyilik canonical/local and below both production latency gates", async () => {
    const probeId = `live-v7-${Date.now()}`;
    ...
    console.log("LIVE_FIRST_ENCOUNTER_V7_GREEN", JSON.stringify({
