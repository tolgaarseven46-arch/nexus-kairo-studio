...
const d:DialogueDecisionPlan={move:"natural_reaction",allowFollowUpQuestion:true,allowSpeculation:false,maxSentences:2,maxWords:32,hasSupportedTargetClaim:false,reason:"test"};
const s:KairoSpeechIdentity={register:"casual",relationshipLevel:"close",sentenceLength:"short",slangLevel:.5,humorLevel:.9,emojiLevel:1,warmthLevel:1,directness:.5,informalityLevel:.7,humorMode:"irony",rhythm:{} as KairoSpeechIdentity["rhythm"],emotionalDisplayLevel:.8,instructions:[]};
