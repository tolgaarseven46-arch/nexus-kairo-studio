...
export function buildPrivatRoomConversationGraphObservation(input: {
  ...
  for (const participant of roster) {
    if (
      ...
      throw new Error("invalid_privatroom_room_participant_fact");
    }
    ...
    participantFacts.set(participant.participantId, {
      ...
      platformRoles: Array.isArray(participant.platformRoles)
        ? [...participant.platformRoles]
        : platformRolesFor(participant.participantId, event),
    });
  }
