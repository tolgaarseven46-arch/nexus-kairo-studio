...
vi.mock("firebase/firestore", () => ({
  ...
  writeBatch: vi.fn(() => ({
    set: (_ref: unknown, value: { dynamicState?: DroitDynamicState }) => {
      if (value.dynamicState) firestoreMemory.dynamicState = JSON.parse(JSON.stringify(value.dynamicState)) as DroitDynamicState;
    },
