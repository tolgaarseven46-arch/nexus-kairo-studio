...
const s: KairoSpeechIdentity = { register:"casual", relationshipLevel:"close", sentenceLength:"short", slangLevel:.5, humorLevel:1, emojiLevel:1, warmthLevel:1, directness:.5, informalityLevel:.7, humorMode:"dry", rhythm:{} as KairoSpeechIdentity["rhythm"], emotionalDisplayLevel:.8, instructions:[] };
