...
selfMemoryQuery = null veya {"surface":"kullanıcının Kaira'nın benliği/geçmişi hakkında sorduğu kısa konu","scope":"self_fact|autobiographical_memory|any","factKey":"opsiyonel_canonical_key","retrievalMode":"targeted|broad","confidence":0-1}; yalnız soru Kaira'nın KENDİ tercihi/inancı/özelliği/biyografisi ya da Kaira'nın KENDİ yaşadığı geçmiş bir olay hakkındaysa doldur. Başka insanların anıları, konuşma geçmişindeki kullanıcı bilgileri veya genel dünya bilgisi için doldurma. Tercih/inanç/trait/biography sorusunda scope=self_fact; yaşanmış olay/anı/geçmiş deneyim sorusunda scope=autobiographical_memory; ikisi gerçekten ayrıştırılamıyorsa any. Belirli kişi/olay/yer/konu aranıyorsa retrievalMode=targeted; kullanıcı genel olarak "geçmişinde neler yaşadın", "en önemli anın ne" gibi açık uçlu otobiyografi soruyorsa retrievalMode=broad. self_fact için canonical anahtar açıkça çıkarılabiliyorsa factKey doldur (örn. favorite_flower, preferred_clothing_color); emin değilsen factKey'i yazma, yeni key uydurma.
