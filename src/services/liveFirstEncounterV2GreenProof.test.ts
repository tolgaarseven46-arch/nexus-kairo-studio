...
describe("LIVE GREEN proof: first-encounter continuity + latency v2", () => {
  it("keeps contextual iyilik on canonical local well-being path with bounded live latency", async () => {
    const probeId = `live-green-${Date.now()}`;
    ...
    console.log("LIVE_FIRST_ENCOUNTER_V2_GREEN", JSON.stringify({
