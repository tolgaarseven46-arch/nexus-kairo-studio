...
describe("LIVE GREEN proof: first-encounter latency v5", () => {
  it("keeps iyilik local and below both production latency gates", async () => {
    const probeId = `live-v5-${Date.now()}`;
    ...
    console.log("LIVE_FIRST_ENCOUNTER_V5_GREEN", JSON.stringify({
