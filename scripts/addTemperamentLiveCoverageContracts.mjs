...
const testPath = 'src/services/kairaTemperamentLiveCoverageContracts.test.ts';
...
if (!source.includes('temperament live stateDelta coverage')) throw new Error('missing temperament live coverage marker');
console.log('Added temperament live stateDelta coverage contracts');
