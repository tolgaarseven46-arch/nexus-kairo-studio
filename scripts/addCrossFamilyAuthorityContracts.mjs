...
const path = 'src/services/kairaCrossFamilyAuthorityContracts.test.ts';
...
if (!fs.readFileSync(path, 'utf8').includes('cross-family authority contracts')) throw new Error('missing cross-family marker');
console.log('Added cross-family authority contracts');
