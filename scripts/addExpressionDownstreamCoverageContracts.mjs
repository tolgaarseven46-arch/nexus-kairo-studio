...
const testPath = 'src/services/kairaExpressionDownstreamCoverageContracts.test.ts';
...
if (!source.includes('expression downstream coverage')) throw new Error('missing expression downstream coverage marker');
console.log('Added expression downstream coverage contracts');
