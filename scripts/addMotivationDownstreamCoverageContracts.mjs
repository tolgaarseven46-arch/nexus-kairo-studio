...
const testPath = 'src/services/kairaMotivationDownstreamCoverageContracts.test.ts';
...
`);
if (!fs.readFileSync(testPath, 'utf8').includes('motivation downstream coverage')) throw new Error('missing motivation coverage marker');
console.log('Added motivation downstream coverage contracts');
